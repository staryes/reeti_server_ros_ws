 ...
 */
void moveEyesCallback(const std_msgs::UInt8MultiArray& msg)
{
    int num = msg.data.size();
    int rightEyeYaw, rightEyePitch, leftEyeYaw, leftEyePitch;

    rightEyeYaw = msg.data[0];
    rightEyePitch = msg.data[1];
    leftEyeYaw = msg.data[2];
    leftEyePitch = msg.data[3];
    ...
    if(Client)
    {
        ...
        str << "Global.servo.rightEyePan=" << rightEyeYaw
...
int main(int argc, char **argv)
{
   ...
   */
  ros::Subscriber sub = n.subscribe("eyes", 1, moveEyesCallback);
